 ...
 * @author Johan Peitz
 */
class BitmapFontBitmapFont 
{
	private static var _storedFonts:Map<String,BitmapFontBitmapFont> = new Map<String,BitmapFontBitmapFont>();
	 ...
	 * @return				this font
	 */
	public function loadPixelizer(pBitmapData:BitmapData, pLetters:String):BitmapFontBitmapFont
	{
		reset();
	 ...
	 * @return				this font
	 */
	public function loadAngelCode(pBitmapData:BitmapData, pXMLData:Xml):BitmapFontBitmapFont
	{
		reset();
	...
	private function setGlyph(pCharID:Int, pRect:Rectangle, pGlyphID:Int, ?pOffsetX:Int = 0, ?pOffsetY:Int = 0, ?pAdvanceX:Int = 0):Void 
	{
		...
		var symbol:BitmapFontFontSymbol = new BitmapFontFontSymbol();
	 ...
	 */
	public static function store(pHandle:String, pFont:BitmapFontBitmapFont):Void 
	{
	 ...
	 */
	public static function fetch(pHandle:String):BitmapFontBitmapFont 
	{
		var f:BitmapFontBitmapFont = _storedFonts.get(pHandle);
		return f;
	}
