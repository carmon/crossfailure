 ...
 * @author Carmon
 */
class EndSectionController extends AbstractController
{
	...
	public function new(model:AbstractModel) 
	{
		...
		#if android
		_textfield.text = "Game over. Tap anywhere to replay.";
		#else
		_textfield.text = "Game over. Click anywhere to replay.";
		#end
